<div class="section-menu-left">
    <div class="box-logo">
        <a href="{{url('/dasboard')}}" id="site-logo-inner">
            <img class="" id="logo_header" alt="" src="{{url('assets/images/logo/logo.png')}}" data-light="{{url('assets/images/logo/logo.png')}}" data-dark="{{url('assets/images/logo/logo-dark.png')}}">
        </a>
    ...
    <div class="section-menu-left-wrap">
        <div class="center">
            ...
            <div class="center-item">
                <div class="center-heading">Store</div>
                <ul class="menu-list">
                    <li class="menu-item has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="{{url('/product/add-product')}}" class="">
                                    <div class="text">Add Product</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
                                <a href="{{url('/product/list-product')}}" class="">
                    ...
                    <li class="menu-item has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="{{url('/category/list-category')}}" class="">
                                    <div class="text">Category list</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
                                <a href="{{url('/category/add-category')}}" class="">
                    ...
                    <li class="menu-item has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="{{url('/order/order-list')}}" class="">
                    ...
                    <li class="menu-item has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="{{url('/admin/all_user')}}" class="">
                                    <div class="text">All user</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
                                <a href="{{url('/admin/add_user')}}" class="">
        ...
        <div class="bot text-center">
            <div class="wrap">
                <div class="mb-20">
                    <img src="{{url('assets/images/menu-left/img-bot.png')}}" alt="">
                </div>
                <div class="mb-20">
